// ==UserScript==
// @name         Item Quality and Bonus
// @namespace    https://github.com/MWTBDLTR/torn-scripts/
// @version      0.0.2
// @description  Quality and bonus show on items in the item market, auction house, and bazaars. Bonus descriptions on hover.
// @author       MrChurch, original by Snickelfritz
...
(function () {
    ...
    const BONUS_INFO = {
        ...
        102: { name: 'Irradiate', min: 0, max: 30 },
    ...
    const tooltip = {
        ...
        init: function () {
            ...
            this.element = utils.createElement('div', { className: 'snickel-tooltip' });
    ...
    const elements = {
        createBonusElement: (bonus, bonusPercent = null, itemData = null) => {
            ...
            const bonusDiv = utils.createElement('div', {
                textContent: text,
                style: { color },
                dataset
            });
            if (bonus.description) {
                bonusDiv.addEventListener('mouseenter', () => {
                    tooltip.show(bonus.description);
                });
                bonusDiv.addEventListener('mouseleave', () => {
                    tooltip.hide();
                });
            }
            return bonusDiv;
